...
const Card:FC<Props> = ({img, onClick, handleAddFav,handleRemoveFav, handleFavList, title}) => {
  return (
    <div
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-row gap-2 align-middle justify-center mt-5">
          <button className="btn btn-primary w-28" onClick={handleRemoveFav}>remove from fav</button>
          <button className="btn btn-primary w-28" onClick={handleFavList}>Add to Favorites</button>
          </div>
